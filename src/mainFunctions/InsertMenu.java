...
public class InsertMenu extends javax.swing.JFrame {
    ...
    public InsertMenu(String retrievedusername) throws IOException {
    ...
    private void insertData() {
        ...
        try {
            ...
            while ((record = br.readLine()) != null) { //Retrieving All Data from itemlist.txt File.
                ...
                if ("*".equals(product_name)) { //Checks if Data are empty, then Data will be inserted into the empty slot.
                    br.close();
                    deleteData(source, product_id, 1, "::"); //Removes Line of Empty Data.
                    String retrievedExtension = insertImage(product_id, oldFileLocation); //Calls insertImage Method with values of product_id and oldFileLocation.
                ...
                } else if ((product_id.equals("10")) && (!"*".equals(product_name))) { //Checks if the Last Line is Empty, Then it Means That All Lines are full and itemlist.txt is full and No Data Will Be Inserted.
                    br.close();
                    checkFull = true;
                }
    ...
    private void retrieveImage() {
        ...
        try {
            ...
            if (selected == JFileChooser.APPROVE_OPTION) { //Opens Window To Select Image File To Upload As Thumbnail Image.
                ...
                lblproduct_thumb.setIcon(scaledIcon); //Sets Icon Image on Label As A Preview.
                oldFileLocation = getselectedImage; //Sets Directory of Selected Image Which Will Be Sent To the insertData() Method.
    ...
    private String insertImage(String insertedProductID, String imageFileSelected) {
    ...
    private void validationMessage() {
        ...
        if ((validateName(txtfproduct_name.getText())) == true
                ...
                && (validateQuantity(txtfproduct_desc.getText())) == false
            ...
            this.validationCondition = false;
    ...
    private void initComponents() {
        ...
        lbltitle.setText("Insert Item Menu");
        ...
        jLabel5.setBounds(40, 130, 30, 20);

        KbtnInsert.setText("Insert Item");
        KbtnInsert.setFont(new java.awt.Font("Gill Sans MT", 1, 18)); // NOI18N
        ...
        pnlDisplay.add(KbtnInsert);
        KbtnInsert.setBounds(130, 660, 300, 70);

        jLabel6.setFont(new java.awt.Font("Gill Sans MT", 0, 12)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("Only .png and .jpg are supported!");
        pnlDisplay.add(jLabel6);
        jLabel6.setBounds(370, 520, 170, 20);

        jLabel7.setFont(new java.awt.Font("Gill Sans MT", 0, 18)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("Item Thumnail Image:");
        pnlDisplay.add(jLabel7);
        jLabel7.setBounds(40, 460, 170, 20);
        ...
        jLabel3.setText("Insert Item Details Into The Vending Machine");
        ...
        if (emptyValidation() == true) {
            ...
            if (validationCondition == true) {
                ...
                if (checkFull == false) {
                    ...
                    int dialogResult = JOptionPane.showConfirmDialog(null, "Item Has Been Successfully Inserted. Would You Like to Insert Another Product?", "Warning", dialogButton);
                    ...
                    JOptionPane.showMessageDialog(null, "Max Amount of Slots Reached!" + "\n" + "Please Remove an Item from a Slot.", "Warning!", JOptionPane.WARNING_MESSAGE);
                    StaffMenu smenu = new StaffMenu(setusername);
                    smenu.setVisible(true);
                    dispose();
                }
