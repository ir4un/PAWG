...
public class UpdateStaff extends javax.swing.JFrame {
    ...
    public UpdateStaff(String retrievedusername) throws IOException {
        ...
        retrieveData(retrievedusername);
    ...
    private void retrieveData(String selectedStaffUsername) {
        ...
        try {
            ...
            while ((record = br.readLine()) != null) {
                ...
                String staff_id = fields[0];
                String staff_username = fields[1];
                String staff_password = fields[2];
                String staff_realName = fields[3];
                String staff_dob = fields[4];
                String staff_email = fields[5];
                String staff_phoneNumber = fields[6];

                if (selectedStaffUsername.equals(staff_username)) { 
                    br.close();
                    lblStaffID.setText("Staff ID: " + staff_id);
                    txtfstaffusername.setText(staff_username);
                    txtfstaffpassword.setText(staff_password);
                    txtfstaffrealname.setText(staff_realName);
                    java.util.Date sdf = new SimpleDateFormat("dd-MM-yyyy").parse(staff_dob);
                    jDateDOB.setDate(sdf);
                    txtfstaffemail.setText(staff_email);
                    txtfstaffphonenumber.setText(staff_phoneNumber);
                }
    ...
    private void insertData() {
        ...
        try {
            ...
            String source = System.getProperty("user.dir") + "\\src\\txtdatabase\\stafflist.txt"; 
            ...
            while ((record = br.readLine()) != null) { 
                ...
                if (setusername.equals(staff_username)) { 
                    br.close();
                    deleteData(source, staff_id, 1, "::"); //Removes Line of Empty Data.
                    FileWriter fw = new FileWriter(file, true);
                    BufferedWriter bf = new BufferedWriter(fw);
                    String newstaff_username = txtfstaffusername.getText(); //Assign Variables Values Based on Input of Textboxes.
                    setusername = newstaff_username;
                    String newstaff_password = txtfstaffpassword.getText();
                    String newstaff_realName = txtfstaffrealname.getText();

                    Date selectedDate = jDateDOB.getDate();
                    SimpleDateFormat sdf = new SimpleDateFormat("dd-MM-yyyy");
                    String newstaff_dob = sdf.format(selectedDate);

                    String newstaff_email = txtfstaffemail.getText();
                    String newstaff_phoneNumber = txtfstaffphonenumber.getText();
                    ...
                    String datalist
                            ...
                            + newstaff_dob + "::"
                            + newstaff_email + "::"
                            + newstaff_phoneNumber
                            + "\n";
                    bf.write(datalist); //Writes the Values From The Variables to the stafflist.txt File.
                    bf.close();
                    br.close();
                    sortData(source, source); //Rearrange the Lines in stafflist.txt Alphabetically.
    ...
    private void staffIDincrement() {
        try {
            ...
            while ((list = br.readLine()) != null) { //Counts total amount of lines within the text file.
                countLine++;
            }
    ...
    private void deleteData(String filepath, String removeterm, int positionOfTerm, String delimiter) throws IOException {
        ...
        String tempFile = System.getProperty("user.dir") + "\\src\\txtdatabase\\temp.txt"; //Creates A Temporary File Which Will Store the Updated stafflist.txt File.
        ...
        try {
            ...
            while ((readData = br.readLine()) != null) { //Data in stafflist.txt Will Be Inserted into data Array.
                data = readData.split("::");
            ...
            oldFile.delete(); //Deletes The Original stafflist.txt File.
            File dump = new File(filepath);
            newFile.renameTo(dump); //Renames The temp.txt File to stafflist.txt.
    ...
    private void initComponents() {
        ...
        lbltitle.setText("Update Staff Details");
        ...
        pnlDisplay.add(iconNoSee);
        iconNoSee.setBounds(450, 120, 40, 40);
        ...
        pnlDisplay.add(iconSee);
        iconSee.setBounds(450, 120, 40, 40);
        ...
        KbtnUpdate.setBounds(120, 550, 300, 70);
        ...
        txtfstaffpassword.setToolTipText("At Least 5 Characters!");
        ...
        pnlDisplay.add(chkpass);
        chkpass.setBounds(0, 0, 85, 20);
        ...
        lblStaffID.setFont(new java.awt.Font("Gill Sans MT", 3, 24)); // NOI18N
        lblStaffID.setForeground(new java.awt.Color(255, 255, 255));
        lblStaffID.setText("Staff ID: 000");
        pnlSlotID.add(lblStaffID, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, -1, -1));
        ...
        setSize(new java.awt.Dimension(1030, 606));
    ...
    private void KbtnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_KbtnUpdateActionPerformed
        if (emptyValidation() == true) {
            ...
            if (validationCondition == true) {
                insertData();
                JOptionPane.showMessageDialog(null, "Update Successfully Saved!");
